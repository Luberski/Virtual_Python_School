...
export const notifyAssignmentGraded = (i18msg: string) =>
  toast.custom(
    (to) => (
      <button
        type="button"
    ...
    {
      id: 'classroom-assignment-graded-notification',
      position: 'top-center',
      duration: 1000,
    }
  );

export const notifyAssignmentSubmitted = (i18msg: string) =>
  toast.custom(
    (to) => (
      <button
        type="button"
    ...
    {
      id: 'classroom-assignment-submitted-notification',
      position: 'top-center',
      duration: 1000,
    }
  );
...
export const notifyAssignmentCreated = (i18msg: string) =>
  ...
  export const notifyAccessCodeCopied = (i18msg: string) =>
    toast.custom(
      (to) => (
        <button
          type="button"
      ...
      {
        id: 'classroom-access-code-copied-notification',
        position: 'top-center',
        duration: 1000,
      }
    );
