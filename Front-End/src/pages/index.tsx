      ...
      <div className="absolute w-full h-full ">
        ...
        <div className="container px-6 mx-auto">
          <div className="flex justify-center w-full h-full space-x-12">
            <div className="flex flex-col p-8 bg-emerald-200 shadow-md hover:shadow-xl hover:shadow-emerald-400/50 transition duration-500 ease-in-out hover:scale-110 shadow-emerald-200/50 rounded-xl text-gray-700 ">
            ...
            <div className="flex flex-col p-8 bg-indigo-200 shadow-md hover:shadow-xl hover:shadow-indigo-400/50 transition duration-500 ease-in-out hover:scale-110 shadow-indigo-200/50 rounded-xl text-gray-700 ">
