      ...
      <div className="h-full w-full">
        ...
        <div className="container mx-auto px-4">
          <div className="brand-shadow2 container flex flex-col rounded-lg bg-white p-9 shadow-black/25 dark:bg-neutral-800">
            ...
            <StyledDialog
              title={t('Courses.create-new-course')}
              ...
              onClose={() =>
                setIsCourseCreateDialogOpen(!isCourseCreateDialogOpen)
              }>
              <div className="mt-6">
                <form
            ...
            <StyledDialog
              ...
              onClose={() =>
                setIsCourseDeleteDialogOpen(!isCourseDeleteDialogOpen)
              }>
              <div className="my-2">
                <p className="my-2 font-bold text-red-400">
                  {t('Courses.delete-course-confirmation')}
                </p>
