...
export default function FancyCard({
  ...
  return (
    <div
      className={`flex flex-col justify-between p-6 ${cardColor} ${darkCardColor} brand-shadow2 border shadow-black/25 dark:border-neutral-400 ${hoverShadowColor} transition duration-500 ease-in-out ${shadowColor} max-h-96 w-96 rounded-lg text-neutral-700 dark:text-neutral-100`}>
